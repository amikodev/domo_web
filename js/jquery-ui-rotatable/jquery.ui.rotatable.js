...
$.widget("ui.rotatable", $.ui.mouse, {
    ...
    _create: function() {
        ...
        //alert( this.element.data("rotate-angle") );
        //alert( this.options.angle );
        if(this.options.angle != false){
            this.elementCurrentAngle = this.options.angle;
            this.performRotation(this.elementCurrentAngle);
        } else if(this.element.data("rotate-angle") != "undefined"){
            this.elementCurrentAngle = this.element.data("rotate-angle")*Math.PI/180;
            this.performRotation(this.elementCurrentAngle);
        } else{
