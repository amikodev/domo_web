...
<div class="span-19">
    ...
    <div style="float: right;"><?=CHtml::link('Просмотр', array('site/scene', 'id'=>$scModel->id))?></div>
...
<? Yii::app()->clientScript
        ...
        ->registerCss('sceneupdate-style-code', '
...
')
        ...
        ->registerScript('sceneupdate-script-code', '

//var TYPE_TEXT = '.SceneWidget::TYPE_TEXT.';
//var TYPE_DEVICEVALUE = '.SceneWidget::TYPE_DEVICEVALUE.';
//var TYPE_TEXT = '.SceneWidget::TYPE_CHECKBOX.';

//$("#widgetIcon").DomoWidget();
//$("#widgetIcon").DomoWidget();
//$("#widgetAdd").DomoWidget();
//return;
