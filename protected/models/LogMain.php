...
/**
 * This is the model class for table "{{LogMain}}".
 *
 * The followings are the available columns in table '{{LogMain}}':
 * @property integer $id
 ...
 */
class LogMain extends CActiveRecord
{
	/**
	 ...
	 * @return LogMain the static model class
	 */
